                                    ...
                                    <CardBody>
                                        <div className="d-flex flex-column h-100">
                                                    ...
                                                    <div className="d-flex gap-1 align-items-center">
                                                        ...
                                                        <UncontrolledDropdown direction='start'>
                                                            ...
                                                            <DropdownMenu className="dropdown-menu-end">
                                                                <DropdownItem href="apps-projects-overview2"><i className="ri-eye-fill align-bottom me-2 text-muted"></i> View More</DropdownItem>
                                                                <DropdownItem href="apps-projects-create"><i className="ri-pencil-fill align-bottom me-2 text-muted"></i> Launch</DropdownItem>
                                            ...
                                            <div className="d-flex mb-2">
                                                ...
                                                <div className="flex-grow-1">
                                                    <h5 className="mb-1 fs-16"><Link to="/apps-projects-overview2" className="text-dark">{item.label}</Link></h5>
                                    ...
                                    <Card>
                                        <CardBody>
                                            <div className={`p-3 mt-n3 mx-n3 bg-soft-${item.cardHeaderClass} rounded-top`}>
                                                <div className="d-flex align-items-center">
                                                    <div className="flex-grow-1">
                                                        <h5 className="mb-0 fs-15"><Link to="/apps-projects-overview2" className="text-dark">{item.label}</Link></h5>
                                                    </div>
                                                    <div className="flex-shrink-0">
                                                        <div className="d-flex gap-1 align-items-center my-n2">
                                                            ...
                                                            <UncontrolledDropdown direction='start'>
                                                                ...
                                                                <DropdownMenu className="dropdown-menu-end">
                                                                    <DropdownItem href="apps-projects-overview2"><i className="ri-eye-fill align-bottom me-2 text-muted"></i> View</DropdownItem>
                                                        ...
                                                        {item.subItem.map((item, key) => (
                                                            <React.Fragment key={key}>
                                                                {item.imgTeam ? <Link to="#" className="avatar-group-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Darline Williams">
                                                                    ...
                                                                    <div className="avatar-xxs">
                                                                        <div className={item.test ? "avatar-title rounded-circle bg-" + item.test : "avatar-title fs-16 rounded-circle bg-light border-dashed border text-primary"}>
                                                                            {item.imgNumber}
                                                                        </div>
                                                                    </div>
                                                                </Link>}
                                    ...
                                    <Col xxl={3} sm={6} className="project-card">
                                        <Card>
                                            <CardBody>
                                                ...
                                                <div className="py-3">
                                                    <h5 className="fs-15 mb-3"><Link to="/apps-projects-overview2" className="text-dark">{item.label}</Link></h5>
                                                    <Row className="gy-3">
                                                        <Col xs={6}>
                                                            <div>
                                                                <p className="text-muted mb-1">Status</p>
