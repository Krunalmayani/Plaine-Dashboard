                                                    ...
                                                    <div className="d-flex gap-1 align-items-center">
                                                        ...
                                                        <UncontrolledDropdown direction='start'>
                                                            ...
                                                            <DropdownMenu className="dropdown-menu-end">
                                                                <DropdownItem href="notebook-overview"><i className="ri-eye-fill align-bottom me-2 text-muted"></i> View More</DropdownItem>
                                    ...
                                    <Card>
                                        <CardBody>
                                            <div className={`p-3 mt-n3 mx-n3 bg-soft-${item.cardHeaderClass} rounded-top`}>
                                                <div className="d-flex align-items-center">
                                                    <div className="flex-grow-1">
                                                        <h5 className="mb-0 fs-15"><Link to="/notebook-overview" className="text-dark">{item.label}</Link></h5>
                                                    </div>
                                                    <div className="flex-shrink-0">
                                                        <div className="d-flex gap-1 align-items-center my-n2">
                                                            ...
                                                            <UncontrolledDropdown direction='start'>
                                                                ...
                                                                <DropdownMenu className="dropdown-menu-end">
                                                                    <DropdownItem href="notebook-overview"><i className="ri-eye-fill align-bottom me-2 text-muted"></i> View</DropdownItem>
                                    ...
                                    <Col xxl={3} sm={6} className="project-card">
                                        <Card>
                                            <CardBody>
                                                ...
                                                <div className="py-3">
                                                    <h5 className="fs-15 mb-3"><Link to="/notebook-overview" className="text-dark">{item.label}</Link></h5>
                                                    <Row className="gy-3">
                                                        <Col xs={6}>
                                                            <div>
                                                                <p className="text-muted mb-1">Status</p>
