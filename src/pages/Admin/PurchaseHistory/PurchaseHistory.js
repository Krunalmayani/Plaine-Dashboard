...
import { purchaseHistorysList } from "../../../common/data";
...
function PurchaseHistory(props) {
    ...
    document.title = " Plaine | Admin/PurchaseHistorys";
    ...
    const columns = useMemo(
        () => [
            ...
            // },
            {
                ...
                Cell: (invoice) => (
                    <>
                        {handleValidDate(invoice.row.original.purchaseDate)},{" "}
                        <small className="text-muted">{handleValidTime(invoice.row.original.purchaseDate)}</small>
                    </>
                ),
            },
    ...
    return (
        <React.Fragment>
            ...
            <Container fluid>
                ...
                <Row>
                    <Col lg={12}>
                        <Card id="PurchaseHistorys">
                            <CardHeader className="border-0">
                                <div className="d-flex align-items-center">
                                    <h5 className="card-title mb-0 flex-grow-1 fs-17"> Purchase History</h5>
                                ...
                                <div>
                                    {invoices.length ? (
                                        <TableContainer
                                            ...
                                            SearchPlaceholder='Search for Name, Email, Role, status or something...'
