...
import { ticketsAdminTable } from '../../../common/data';
                ...
                Cell: (cellProps) => {
                    return <>
                        ...
                        <small className="text-muted">
                            {
                              cellProps.row.original.subEmail 
                            }
                        </small>
                    </>
                },
                ...
                <Col lg={12}>
                    <Card>
                        ...
                        <CardBody className='pt-0'>
                            {ticketsAdminTable.length ? (
                                <TableContainer
                                    columns={columns}
                                    data={(ticketsAdminTable || [])}
                                    isGlobalFilter={true}
                                    isAddUserList={false}
                                    customPageSize={8}
                ...
                <Form className="tablelist-form" onSubmit={(e) => {
                    ...
                    <ModalBody>
                        <Row className="g-3">
                            ...
                            <Col lg={6}>
                                <Label htmlFor="ticket-status" className="form-label">Category</Label>
                                <Input
                                    name="status"
                                    type="select"
                                ...
                                >
                                    ...
                                    <option value="AI/MlModel">AI/ML Model</option>
                                    <option value="Security">Security</option>
                                    <option value="AI/MLNotebook">AI/ML Notebook</option>
