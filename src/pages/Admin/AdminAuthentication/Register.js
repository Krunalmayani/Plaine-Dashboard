...
// action
import { registeradmin, apiError, resetRegisterFlag } from "../../../slices/auth/AdminRegister/thunk";
                        ...
                        <Row className="justify-content-center">
                            <Col md={8} lg={6} xl={5}>
                                <Card className="mt-4">
                                    ...
                                    <CardBody className="p-4">
                                        <div className="text-center mt-2">
                                            ...
                                            <p className="text-muted">Get your free Plaine account now</p>
                                        </div>
                                        <div className="p-2 mt-4">
                                            <Form
                                                ...
                                                <div className="mb-4">
                                                    <p className="mb-0 fs-12 text-muted fst-italic">By registering you agree to the Plaine
                                ...
                                <div className="mt-4 text-center">
                                    <p className="mb-0">Already have an account ? <Link to="/admin" className="fw-semibold text-primary text-decoration-underline"> Signin </Link> </p>
                                </div>
                            </Col>
                        </Row>
                    </Container>
