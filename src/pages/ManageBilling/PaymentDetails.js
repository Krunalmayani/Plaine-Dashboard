...
import logoDark from "../../assets/images/logo_cd.png";
import logoLight from "../../assets/images/logo-light.png";

function PaymentDetails(props) {
    document.title = "Payment Details | Plaine - Unleashing Innovation with Artificial Intelligence";
    ...
    return (
        ...
        <div className="page-content">
          <Container fluid={true}>
            <BreadCrumb title="Payment Details" pageTitle="Invoices" />
                      ...
                      <CardHeader className="border-bottom-dashed p-4">
                        <div className="d-flex">
                          ...
                          <div className="flex-shrink-0 mt-sm-0 mt-3">
                            ...
                            <h6><span className="text-muted fw-normal">Email:</span><span id="email">Vishal@plaine.gnyan.ai</span></h6>
                            <h6><span className="text-muted fw-normal">Website:</span> <Link to="https://plaine.gnyan.ai/" className="link-primary" target="_blank" id="website">plaine.gnyan.ai</Link></h6>
                            ...
                            <tbody id="products-list">
                              <tr>
                                ...
                                <td className="text-start">
                                  <span className="fw-semibold">HSN Code Classifier</span>
                                  <p className="text-muted mb-0">Custom App</p>
                                </td>
                                <td>$119.99</td>
                                <td>02</td>
                              ...
                              <tr>
                                <th scope="row">02</th>
                                <td className="text-start">
                                  <span className="fw-semibold">Classic Cinema Colorizer</span>
                                  <p className="text-muted mb-0">Notebook</p>
                                </td>
                                <td>$94.99</td>
                                <td>01</td>
                              ...
                              <tr>
                                <th scope="row">04</th>
                                <td className="text-start">
                                  <span className="fw-semibold">Lead Deduplication Automation</span>
                                  <p className="text-muted mb-0">AI Model</p>
                                </td>
                                <td>$340.00</td>
                                <td>01</td>
