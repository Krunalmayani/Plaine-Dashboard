                            ...
                            <Row>
                                <div className="col-md">
                                    <Row className="align-items-center">
                                        ...
                                        <div className="col-md">
                                            <h4 className="fw-semibold" id="ticket-title">#Can't Able to Make a Payment</h4>
                                            <div className="hstack gap-3 flex-wrap">
                                                <div className="text-muted"><i className="ri-building-line align-bottom me-1"></i> <span id="ticket-client">Billing</span></div>
