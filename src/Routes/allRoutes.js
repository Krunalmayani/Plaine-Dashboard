...
import Dashboard from "../pages/DashboardEcommerce/Dashboard";
...
import ProjectList2 from "../pages/Projects2/ProjectList2";
...
import ProjectOverview2 from "../pages/Projects2/ProjectOverview2";
import InvoiceList2 from "../pages/Invoices2/InvoiceList";
import InvoiceDetails2 from "../pages/Invoices2/InvoiceDetails";
import ListView2 from "../pages/SupportTickets2/ListView2";
import JobGrid2 from "../pages/Jobs/JobList2/Grid";
import EcommerceCar2 from "../pages/Ecommerce2/EcommerceCart";
import EcommerceCheckout2 from "../pages/Ecommerce2/EcommerceCheckout";
import Faqs2 from "../pages/Pages/Faqs2/Faqs";
import Settings2 from "../pages/Pages/Profile2/Settings/Settings";
import Pricing2 from "../pages/Pages/Pricing2/Pricing";
...
import NotebookOverview from "../pages/Pages/HelpProject/ProjectOverview2";
import TeamMembers from "../pages/TeamMembers/CrmContacts";
...
const authProtectedRoutes = [
  ...
  { path: "/apps-ecommerce-cart2", component: <EcommerceCar2 /> },
  { path: "/apps-ecommerce-checkout", component: <EcommerceCheckout /> },
  { path: "/apps-ecommerce-checkout2", component: <EcommerceCheckout2 /> },
  ...
  { path: "/apps-projects-list2", component: <ProjectList2 /> },
  { path: "/notebook", component: <Notebook /> },
  { path: "/project", component: <Project /> },
  { path: "/apps-projects-overview", component: <ProjectOverview /> },
  { path: "/apps-projects-overview2", component: <ProjectOverview2 /> },
  ...
  { path: "/apps-invoices-list2", component: <InvoiceList2 /> },
  { path: "/apps-invoices-details", component: <InvoiceDetails /> },
  { path: "/apps-invoices-details2", component: <InvoiceDetails2 /> },
  ...
  //Supports Tickets
  { path: "/apps-tickets-list2", component: <ListView2 /> },
  { path: "/apps-tickets-details2", component: <TicketsDetails /> },
  ...
  { path: "/apps-job-grid-lists2", component: <JobGrid2 /> },
